...
PusherBorisCustom::PusherBorisCustom( Params &params, Species *species )
    : Pusher( params, species )
{
}

PusherBorisCustom::~PusherBorisCustom()
{
}
...
void PusherBorisCustom::operator()( Particles &particles, SmileiMPI *smpi, int istart, int iend, int ithread, int ipart_buffer_offset )
{
